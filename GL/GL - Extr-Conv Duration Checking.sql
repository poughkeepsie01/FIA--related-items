SELECT  c.user_concurrent_program_name, 
        ...
        DECODE(a.actual_completion_date,null,TO_CHAR(TO_DATE('00:00:00','HH24:MI:SS') + (SYSDATE - a.actual_start_date),'HH24:MI:SS'),'Completed') RUNTIME, 
        TO_CHAR(TO_DATE('00:00:00','HH24:MI:SS') + (a.actual_completion_date - a.actual_start_date),'HH24:MI:SS') Duration,         
...
WHERE 1=1
        ...
        AND b.user_je_source_name = 'Cost Management'                
        AND a.concurrent_program_id = c.concurrent_program_id
--        AND TO_CHAR(a.actual_start_date,'MM/DD/YYYY') = '01/31/2019'
        AND (a.actual_start_date <= SYSDATE AND a.actual_start_date >= SYSDATE - 5)        
